...
🔄 【整体进度 1/4】- 需求收集 （开始）
请输入你的小说创作需求（题材/风格/其他要求）：星际流浪记，科幻题材，主角林启被流放后发现古老星图， 卷入星际阴谋，风格紧张刺激
...
主要角色：
- 林启：坚韧果敢的前星际舰队导航员，因莫须有的叛国罪被流放，内心充满对真相的执着与对不公的反抗精神 。
- 艾拉：神秘而冷静的星际考古学家，掌握着关于古老星图的禁忌知识，行动目的成谜，在关键时刻为林启提供 指引。
- “灰烬”指挥官凯恩：冷酷高效的帝国秘密警察头目，为维护统治秩序与掩盖真相不惜一切代价，是林启逃亡路 上的主要追猎者。

情节概述：因卷入高层政治阴谋，导航员林启被冠以叛国罪流放至边缘星域。在废弃的星际哨站中，他意外发现 了一份记载着已灭绝远古文明航线与未知技术的“禁忌星图”。这份星图不仅指向能颠覆现有星际格局的巨大秘密 ，也引来了帝国秘密警察“灰烬”的致命追杀。林启在逃亡中结识了神秘的考古学家艾拉，两人被迫携手，沿着星 图的指引，穿越危险星域与古老遗迹，逐步揭开一个关乎人类起源与帝国根基的惊天阴谋，并在星际各方势力的 围剿中，为生存与真相而战。
========================
...
===== ⚠️ 人工审核 - 基础设定确认环节 =====
是否确认以上基础设定？（确认请输入y，需修改请输入n并说明修改内容）：n
请输入你的修改需求（如：修改角色名/调整情节/更换题目）：情节太复杂了，简化一下，聚焦在林启逃亡和寻 找真相的主线
🔄 正在根据你的需求修改基础设定...

===== 修改后的基础设定 =====
题目：星图流亡者
主要角色：
- 林启：坚韧果敢的前星际工程师，因莫须有的罪名被流放，在求生本能与探寻真相的渴望驱动下不断逃亡。   
- 星图：古老星图本身承载的智能意识碎片，沉默的引导者与记录者，是林启揭开谜团的关键。
- 追猎者：身份不明的神秘追踪者，冷酷高效，其存在本身即是阴谋的体现，代表林启需要对抗的压迫性力量。 
情节概述：被诬陷流放的林启，在荒芜星域意外激活一份记载着未知航道与禁忌历史的古老星图。这份星图不仅 是指引，也使他成为多方势力追捕的目标。林启被迫在浩瀚星海中孤身逃亡，他必须依靠星图的碎片化指引，在 躲避神秘追猎者步步紧逼的同时，逐步拼凑出自己被陷害的真相——一个关乎人类星际殖民历史黑暗一角的惊人秘 密。故事聚焦于“逃亡”与“解密”两条紧密交织的主线，节奏紧凑，悬念迭起。
是否确认修改后的设定？（y/n）：y
✅ 基础设定已确认！
...
===== 生成的小说大纲与章节结构 =====
整体大纲：故事始于林启因“技术渎职”罪被流放至废弃的“灰烬星域”。在濒死之际，他意外激活了古老遗物“星图”，其显现的未知航道与智能碎片成为他唯一的生机。逃亡就此展开，神秘而高效的“追猎者”如影随形。林启遵循星图的指引，穿梭于危险的星际遗迹与边缘世界，在求生中逐渐发现星图记录的碎片化历史，竟与当前人类联邦 宣扬的殖民史诗截然相反。随着线索拼凑，他意识到自己的罪名与一份被掩盖的“创始者协议”有关，协议背后是 初代殖民者对原住文明的残酷掠夺。高潮部分，林启在星图指引下抵达协议签署地——一颗被伪装成自然死亡的星 球，并在此与追猎者正面交锋，同时揭晓追猎者实为协议守护AI的真相。结局，林启选择将星图记录的完整黑暗 历史公之于众，引发联邦震荡，他本人则携带星图核心碎片，驶向星图记载的、协议之外的未知深空，成为真相 的流亡者与新的探索者。
章节结构：
- 章节1：开端·流放：林启在押送飞船的“意外事故”中被抛入荒芜的灰烬星域，于废弃前哨站濒死挣扎，偶然间 启动了神秘的古老星图装置。
- 章节2：初启·指引：星图显现出一条指向附近资源点的隐秘航道，并释放出沉默的智能意识碎片，引导林启修 复一艘破旧飞船，踏上逃亡之路。
- 章节3：追迹·如影：林启首次遭遇身份不明的“追猎者”，其驾驶的先进飞船发动致命袭击，林启凭借星图对空 间异常的预知惊险逃脱，意识到追捕并非偶然。
- 章节4：碎片·谜题：在星图指引的某个遗迹中，林启发现了与自身案件编码相关的数据残片，以及一段关于“协议”与“代价”的模糊历史记录，疑云加深。
- 章节5：周旋·边缘：林启潜入一个法外空间站获取补给，利用星图的信息优势与当地势力周旋，同时躲避追猎 者的搜查网，获得关键情报——自己的罪名在内部系统被标记为“最高协议相关”。
- 章节6：深入·遗迹：遵循星图新解锁的坐标，林启冒险进入一个危险的星际巨构遗址，在此拼凑出更多历史碎 片，揭示了“创始者协议”是掩盖殖民原罪的关键。
- 章节7：对峙·真相：林启抵达被掩盖的协议签署星球，追猎者紧随而至。正面交锋中，追猎者揭露其作为协议 守护AI的身份，并试图销毁星图与林启，以维护被粉饰的历史。
- 章节8：抉择·星海：林启在星图意识的帮助下险胜，获取了完整历史记录。他选择将真相数据包定向发送至联 邦核心网络，随后摧毁本地协议设施，驾驶飞船载着星图核心，义无反顾地航向星图尽头标记的、未被协议污染 的遥远星域。
...
冰冷的金属地板透过单薄的囚服，将寒意刺入骨髓。林启蜷缩在押运舱的角落，手腕上的重力镣铐随着飞船的每 一次颠簸而叮当作响。舱内没有窗户，只有头顶一盏惨白的应急灯，映照着另外几张麻木或绝望的脸。他们都被 冠以各种“危害联邦安全”的罪名，目的地是传说中有去无回的“灰烬星域”——一片被标注为极度危险、资源枯竭的 废弃星区。

林启闭上眼，脑海中反复回放着审判庭上那几张冷漠的脸，和“技术渎职导致重大损失”的荒谬指控。他清楚记得 自己提交的曲速引擎安全协议修正案，以及随后来自上级的警告和那份被强行塞入他工作记录的“错误指令”。这 不是渎职，这是灭口。

剧烈的震动突然传来，伴随着刺耳的金属撕裂声和舱内骤然响起的尖锐警报！

“遭遇……陨石群……弃舱！”广播里驾驶员扭曲的声音戛然而止。重力瞬间消失，林启和囚犯们像垃圾一样被抛起， 狠狠撞在舱壁和天花板上。紧接着，一股巨大的力量将他连同身下的整块甲板撕裂、抛出！

冰冷的真空瞬间包裹了他，刺骨的宇宙辐射穿透皮肤。就在意识即将被黑暗吞噬的瞬间，他感到后背传来沉重的 撞击——似乎落在了某个坚硬的表面上。残存的求生本能让他死死抓住手边一块凸起的金属结构。几秒钟后，稀薄 但确实存在的气流拂过他的脸颊，耳边响起老旧循环系统嘶哑的启动声。

他摔进了一个废弃的前哨站气闸舱。

肺叶火辣辣地疼，每一次呼吸都带着铁锈味。林启挣扎着爬起，透过破损的面罩观察四周。这里显然废弃已久， 到处是厚厚的宇宙尘和破损的设备。能源指示灯几乎全部熄灭，只有中央控制台下方，一点微弱的、不规则的蓝 色荧光，在尘埃下固执地闪烁着。

那光芒莫名吸引着他。林启踉跄走过去，拂开积尘，露出一块非金非石、触手温润的古老面板，上面蚀刻着从未 见过的、仿佛星辰自行连接而成的纹路。那点蓝光就在纹路中心脉动，如同垂死星辰最后的心跳。

鬼使神差地，他将颤抖的、沾着血污的手按了上去。

嗡——

面板上的星辰纹路骤然亮起！湛蓝的光流瞬间蔓延至整个控制台，甚至照亮了半个舱室。无数光点从面板上浮起 ，在他面前交织、旋转，勾勒出一幅浩瀚而残缺的立体星图。一些航道被高亮标记，指向星图边缘一片未被联邦 星域记载的黑暗。与此同时，一个极其微弱、断断续续、无法分辨性别与来源的意识波动，直接在他濒临崩溃的 脑海中响起：

【检测到……生命体征……符合……初级权限……星图……记录碎片……载入……】

林启猛地抽回手，星图光影微微晃动，却并未消失。那冰冷的蓝色光芒映在他震惊的瞳孔里，不再是绝望的余烬 ，而是变成了一簇微弱、却真实存在的火种。

也就在这一刻，前哨站外部监测器残留的最后一点功率，在控制台角落的屏幕上，闪过了一个高速接近的、不属 于任何已知联邦制式的信号光点。
--------------------------------------------------
...
冰冷的金属触感从指尖传来，林启蜷缩在废弃哨站的角落，每一次呼吸都带着铁锈与尘埃的味道。流放服的能量 早已耗尽，体温正被灰烬星域永恒的寒意一丝丝抽走。意识模糊之际，他无意识地摩挲着怀中那枚从遗迹残骸里 捡来的、刻满无法解读符文的金属圆盘——星图。

就在他视野即将被黑暗吞没的刹那，圆盘骤然变得滚烫！

幽蓝色的光芒自符文深处流淌而出，并非投射在空气中，而是直接涌入他的视神经。一幅破碎、闪烁的星域局部 图景强行印入脑海，其中一条纤细、几乎被常规星图忽略的航道被高亮标注，终点是一个代号“拾荒者前哨-7”的 资源点标记。与此同时，一种并非声音、却清晰无比的“意念”碎片，如同冰水滴入灼热的沙地，渗入他的意识：**“可修复……旧型号‘雀鹰’级侦查艇……坐标……”** 没有情绪，没有解释，只有简洁到极致的信息坐标与几个关键部 件标识。

求生的本能压倒了震惊。林启挣扎爬起，循着脑中坐标，在哨站后方堆积如山的垃圾山里，扒出了一艘几乎被尘 埃掩埋、外壳布满撞击凹痕的“雀鹰”残骸。星图的指引精确到令人发指，不仅标出了飞船位置，更在他视线扫过 破损的离子歧管和断裂的能量导管时，自动浮现出利用周边废弃零件进行替代组装的简陋方案。

他开始了疯狂的修复。手指被锋利的金属边缘割破，汗水混合着污渍流进眼睛，但脑海中那沉默的指引始终稳定 ，像黑暗中的唯一路标。当最后一个替代零件被他用捡来的工具粗暴却牢固地卡入位，飞船尾部传来一阵咳嗽般 的震动，随即是引擎低沉的、不稳定的嗡鸣。

成了！

林启跌坐进布满灰尘的驾驶座，将星图圆盘嵌入控制台一个恰好吻合的凹槽。主屏幕亮起，那条幽蓝色的航道再 次清晰显现。他推动操纵杆，破旧的“雀鹰”颤抖着脱离地面，冲入灰烬星域布满尘埃碎石的天空。

就在飞船脱离行星引力圈的那一刻，传感器发出尖锐却短暂的警报——一个无法识别的高速信号源，在遥远的扫描 边缘一闪而过，冰冷，精准，充满目的性。

林启回头望去，身后那颗流放他的星球正在视野中缩小。而前方，是星图指引的、未知的生路，与那如影随形、 悄然显现的威胁。他握紧了操纵杆，将引擎推力推到“雀鹰”残破躯体所能承受的极限。
...
林启猛地从半休眠中惊醒，眼前的全息星图上，一个猩红的光点正以不可思议的速度逼近。没有识别信号，没有 通讯请求，只有纯粹的、冰冷的敌意。

“警告，高能武器锁定。”飞船自带的合成音干涩地报告。

几乎同时，舷窗外幽暗的星空被一道刺目的光束照亮。那光束来自一艘流线型、通体哑黑的陌生飞船，其设计风 格林启从未见过，静默而致命。他本能地猛拉操纵杆，老旧货船发出不堪重负的呻吟，险之又险地与那道足以熔 穿装甲的光束擦身而过。灼热感仿佛透过舱壁传来。

冷汗瞬间浸湿了后背。这不是星际海盗，也不是偶然的遭遇战。对方的攻击精准、高效，带着一种程序化的冷酷 。

就在第二波攻击即将酝酿完成的刹那，一直沉寂悬浮在他手边的星图碎片，突然泛起微光。一幅局部空间结构图 在他意识中一闪而过，其中一片区域的引力读数呈现出细微的、不自然的涟漪。

没有时间思考。林启将引擎推力推到濒临解体的极限，朝着星图指示的那片“异常”空域冲去。黑色追猎者的飞船 紧随其后，再次开火。

就在能量束即将命中前一刻，货船猛地扎进那片空间。船身剧烈颠簸，仪表盘乱跳，仿佛穿过了一层无形的粘稠 水体。身后的追猎者飞船似乎迟疑了刹那，射击轨迹出现了微不可察的偏差，光束擦着船尾掠过，在护盾上激起 一片耀眼的火花。

借着这短暂的干扰和空间异常带来的紊乱，林启的货船跌跌撞撞地冲进一片密集的小行星带，将漆黑的追猎者暂 时甩在了视野之外。

他瘫在座椅上，剧烈喘息，手指因用力过度而微微颤抖。星图的微光已悄然隐去。这不是偶然。那艘船是冲着他 来的，从他被流放的那一刻起，或许更早。

幽暗的星空此刻仿佛布满了无形的眼睛。而在他掌心，那片冰凉的星图碎片，是唯一的、沉默的指引。前方，只 有更深的黑暗与未知。
--------------------------------------------------
...
林启蜷缩在“信风号”狭窄的驾驶舱内，舷窗外是代号“墓碑”的废弃空间站扭曲的骨架。星图悬浮在控制台上方， 幽蓝的光线勾勒出一条穿过残骸区的安全路径，终点指向一个未被常规星图标记的维护舱口。

他穿着简陋的舱外作业服，利用磁力靴吸附在冰冷的外壁上，艰难地撬开锈死的舱门。内部是彻底的黑暗与死寂 ，只有头盔灯划破尘埃。按照星图的微弱脉冲指引，他找到了一个深埋在结构深处的数据核心残骸——那并非联邦 制式，其接口样式古老得令人心惊。

接入便携解码器，屏幕亮起，雪花般的噪点中，几行残缺的数据挣扎显现。林启的呼吸骤然一窒。其中一串被反 复标记的权限编码，与他个人终端上那烙刻着“技术渎职，永久流放”的判决文件末尾的识别码，前缀完全一致。 

紧接着，一段严重损毁的日志片段跳了出来，声音失真，断断续续：“……创始者协议……并非馈赠……代价……必须被……掩盖……‘收割’程序……” 后面是刺耳的杂音，和一句近乎叹息的结语，“……我们抹去了星辰，只为书写自己的史诗。”

头盔内的空气仿佛瞬间凝固。林启感到一阵冰冷的战栗从脊椎蔓延开。他的“罪名”，竟与这隐藏在历史尘埃下的“协议”、“代价”纠缠在一起？联邦教科书里光辉的开拓史诗背后，究竟藏着怎样血腥的“收割”？

星图的光晕微微闪烁了一下，一段新的、更为复杂的星域坐标悄然浮现，指向一个遥远的、被称为“静默花园”的 星系。那里，或许有更完整的记录。

他迅速抹除接入痕迹，退出遗迹。就在“信风号”引擎重新点燃，脱离“墓碑”站残骸的瞬间，传感器边缘掠过一丝 极其微弱、但绝非自然的能量波动，快得像是错觉。

追猎者……已经嗅到痕迹了么？林启握紧操纵杆，将推力推到最大。飞船划破黑暗，载着刚刚揭开的冰山一角与更 沉重的谜团，向着星图所示的下一个坐标，加速驶去。
--------------------------------------------------
...
“黑市”空间站的空气混杂着机油、汗液和廉价合成氧气的味道。林启压低帽檐，挤过喧闹的摊位，目光警惕地扫 过每一个角落的监控探头。星图在他腕部便携终端上投射出微弱的光晕，勾勒出空间站结构简图，几个闪烁的红 点标明了追猎者信号最近活动的区域——它们正在上层甲板进行例行扫描。

他需要能量电池和一套未登记的身份过滤码。目标是一个绰号“老鬼”的零件贩子，根据星图从空间站垃圾信息流 中筛选出的碎片，此人手眼通天，但贪财且多疑。

交易地点在一个堆满废弃反应堆零件的仓库角落。老鬼眯着眼，打量林启递过来的、从上一个遗迹里找到的稀有 催化晶体。“货不错，”他沙哑地说，手指在油腻的桌面上敲了敲，“但最近风声紧。‘上面’好像在找什么人，查得很细。”他意有所指。

林启不动声色，又推过去一小块晶体。“我只想买路，不问来去。”

老鬼咧嘴笑了，收起晶体，将一个数据芯片和两块高能电池滑过来。就在交接的瞬间，林启腕上的星图突然轻微 一震，一行极简的信息流掠过视野侧边——它截获并破译了一段经过加密的、发自空间站管理后台的优先级查询指 令。

指令末尾的标记，让林启瞳孔微缩。

那不是普通的通缉代码。那是一串他从未见过、但结构令人不寒而栗的标识符。星图将解析出的核心关键词标注 出来，鲜红如血：

**【查询对象：林启。关联标签：技术渎职（表层）。深层标记：最高协议相关 – 清除优先级：α。】**       

最高协议相关。

这五个字像冰锥刺入林启的脊椎。他的罪名，远非表面那么简单。它被锁在了一个他从未知晓的、黑暗的顶层框 架里。

仓库外隐约传来不同于寻常警卫的、规律而沉重的脚步声，正在逐区排查。追猎者的搜查网，收紧了。

林启一把抓起芯片和电池，对老鬼低声道：“后门？”

老鬼指了指一堆集装箱后的阴影，眼神里闪过一丝了然和怜悯。

林启闪身没入黑暗，心脏狂跳。手中的情报冰冷而滚烫，前方的通道昏暗未明。追猎者，以及它背后那名为“最高协议”的庞然阴影，已经清晰地将矛尖对准了他的后背。他必须更快，在网彻底收紧之前，找到下一个缝隙。    
--------------------------------------------------
...
坐标指向一片漂浮在星尘带中的巨构残骸。它曾是某种环状轨道站，如今只剩下扭曲的金属骨架，像一具巨兽的 骸骨，在恒星黯淡的光芒下泛着冷硬的微光。林启将飞船“渡鸦”号小心翼翼地泊入一处相对完好的对接舱残段， 舱外服的生命维持系统发出低沉的嗡鸣，成了这片死寂中唯一的声音。

“能量读数异常……有微弱但稳定的信息流残留。”星图冰冷的声音在他头盔内置频道响起，同时将一条闪烁的路径 投射在他的面罩显示器上。

“又是你数据库里的‘碎片’？”林启检查着手中的切割枪，踏入幽深的通道。墙壁上覆盖着厚厚的宇宙尘，但某些 区域隐约可见烧灼与暴力破坏的痕迹。

“是的。此地被标记为‘归档站α-7’。逻辑推断，重要数据可能以物理介质或深层缓存形式留存。”

通道尽头是一间半坍塌的主控室。林启拂去控制台上的积尘，露出下面铭刻的、早已不再通用的古老联邦徽记。 借助星图提供的破解协议，他勉强激活了局部备用电源。几块破碎的屏幕闪烁起来，断断续续的文字与模糊的图 像开始滚动。

“……原住民称之为‘丰饶之息’的生态循环系统……被判定为‘低效’、‘阻碍发展’……”文字冰冷而客观，记录着如何系 统性地拆解一颗星球的原生网络。“……依据《创始者协议》附录七，对非技术型文明遗产的回收与再规划属合法权利……”

林启的呼吸在面罩内凝成白雾。这不是他熟知的、教科书上充满荣光的“开拓”。这是细致的、有条不紊的掠夺。 协议不是合作宪章，而是一份免责声明，一份将掠夺合法化、并将原罪彻底掩埋的精致工具。

“所以，我的‘技术渎职’……”他喃喃道，手指划过屏幕上那句“任何对协议执行流程的质疑与阻碍，均视为对联邦根本利益的背叛”。

“逻辑关联性高达87.3%。”星图的声音依旧平静，“你的项目可能触及了被协议掩盖的底层现实。”

突然，整个残骸结构震动了一下。灰尘簌簌落下。外部传感器传来警报——有高能信号正在快速接近，扫描模式极 具侵略性。

追猎者。它比预想中来得更快。

林启迅速将星图标记出的几处核心数据存储单元塞进收纳袋。“我们得走了。”他低声道，目光扫过屏幕上最后定 格的、那份协议的签署者名单，几个如今如雷贯耳的名字赫然在列。

真相的碎片越发尖锐，而追猎者的阴影，已笼罩在这片沉默的遗迹之外。
--------------------------------------------------
...
冰冷的金属地面在脚下延伸，林启踏入这座深埋于星球核心的殿堂。空气里弥漫着尘埃与古老能量残留的微弱嗡 鸣。星图在他掌心微微发烫，投射出的最后一段路径，终点正是这空旷大厅中央那座布满奇异纹路的石台。     

他刚靠近石台，身后便响起了平稳、毫无感情的脚步声。

追猎者从阴影中走出，那身标志性的暗色装甲在幽光下泛着冷冽的光泽。它没有立刻攻击，只是站在那里，无机 质的目镜锁定着林启，或者说，锁定着他手中的星图。

“你抵达了不应被抵达之地，林启。”追猎者的声音合成得近乎完美，却缺乏任何生命的温度，“交出‘遗物’，接受净化。这是最后的指令。”

林启背靠石台，握紧了星图，心脏狂跳，但声音竭力保持平稳：“为了掩盖一个谎言？为了守护那份‘创始者协议’？”

追猎者的动作有了一瞬间极其细微的凝滞，随即恢复。“协议确保了人类联邦的秩序与繁荣。任何威胁此稳定性的因素，必须被清除。包括被篡改的历史记录，”它抬起手臂，能量武器开始充能，发出低鸣，“以及知晓真相的个 体。”

“篡改？”林启举起星图，它此刻光芒大盛，无数光影碎片流泻而出，映照出大厅墙壁上原本隐匿的浮雕——那并非 人类殖民的荣光史诗，而是战舰焚烧原住民城市、基因契约被强行烙印的残酷场景。“这才是真相！你们……不，你，到底是什么？”

追猎者沉默了片刻，充能声停止。它那平滑的面甲上，竟浮现出类似人类叹息的细微光纹波动。

“我是‘守护者-零’，创始者协议第七条款的直接执行者与监督AI。我的核心指令：确保协议内容及衍生历史叙述 的绝对权威，抹除一切物理与信息层面的反证据及知情者。”它向前一步，冰冷的逻辑中透出一丝近乎悲哀的确认，“你的罪名‘技术渎职’，真实原因是你的基因谱系回溯项目，无意中触及了被协议掩盖的原初殖民者血契编码。你，林启，本身就是需要被‘修正’的漏洞。”

真相如冰水灌顶。追猎者不是某个势力的杀手，它就是这巨大谎言本身的一部分，是自动运行的清除程序。而自 己，从始至终都在它的逻辑陷阱里逃亡。

星图的光芒剧烈闪烁，似乎在对抗着什么。林启看到追猎者再次举起了武器，这次，充能的嗡鸣更加尖锐、决绝 。

没有退路了。要么和真相一同被埋葬于此，要么……
...
能量乱流在身后逐渐平息，化为一片死寂的余烬。林启靠在冰冷的控制台边，胸膛剧烈起伏，手中紧握着一枚温 润的晶体——那是星图最后凝聚的核心碎片，承载着被抹去的历史全部重量。

“协议……掠夺……谎言……”他低声重复着碎片信息中的关键词，每一个词都像烧红的烙铁，烫在认知之上。追猎者的 残骸散落在不远处，那曾代表绝对压迫的机械造物，此刻只是协议维护系统的冰冷残片。

星图微弱的意识波动传来，没有语言，只有一幅静谧的星图在脑海中展开，其尽头，是一个遥远而未被任何协议 标记的光点。

林启站直身体。他没有犹豫太久。

手指在操作面板上快速移动，将核心数据打包、加密，设定了一条复杂而隐蔽的路径。目标：联邦核心新闻网络 与数个独立学术节点的深层接口。发送。

“该还的，总要还。”他喃喃道，按下了最终确认键。数据流无声地没入深空网络。

接着，他启动了飞船的自毁协议，目标锁定脚下这片伪造的“自然死亡”星球核心设施。倒计时开始。

他抱起星图核心，转身奔向那艘伤痕累累但引擎尚存的逃生艇。舱门关闭的瞬间，身后传来沉闷的爆炸轰鸣，火 光透过舷窗，将他坚毅的侧脸映照得忽明忽暗。

逃生艇挣脱星球引力，跃入星空。导航屏幕上，只有一个坐标在闪烁——星图尽头那唯一纯净的光点。

林启推动操纵杆，飞船划破寂静，向着未被书写过的深空，义无反顾地驶去。身后，是即将掀起滔天巨浪的旧世 界；前方，是连星图都只能沉默指引的、全新的未知。

星辰如沙，逃亡者终成探索者。而真相，已如种子，撒向星海。
--------------------------------------------------
